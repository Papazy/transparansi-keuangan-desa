...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2025 at 02:03 PM
...
CREATE TABLE `bidang` (
  ...
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `desa` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_kecamatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `kabupaten` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_provinsi` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `kaur_keuangan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_desa` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jabatan` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `aktif` enum('Ya','Tidak') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Tidak',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kecamatan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_kabupaten` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `kegiatan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_sub_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `penganggaran_belanja` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_penganggaran_tahun` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_penganggaran_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_rekening_objek` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sumber_dana` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uraian` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `penganggaran_bidang` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_desa` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_penganggaran_tahun` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `penganggaran_kegiatan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_penganggaran_sub_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_pelaksana` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lokasi` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `waktu_pelaksanaan` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pagu` bigint(20) DEFAULT 0,
  `keluaran` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `penganggaran_paket_kegiatan` (
  ...
  `pola` enum('Swakelola','Kerjasama','Pihak Ketiga') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sifat_paket` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volume_paket` int(10) UNSIGNED DEFAULT 0,
  `lokasi_paket` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `satuan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `penganggaran_sub_bidang` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_penganggaran_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sub_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `perencanaan_misi` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_visi` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `perencanaan_sasaran` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tujuan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uraian` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `perencanaan_tujuan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_misi` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uraian` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `perencanaan_visi` (
  ...
  `id_kepala_desa` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sekretaris_desa` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `rekening_jenis` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_kelompok` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `rekening_kelompok` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_akun` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `rekening_objek` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_jenis` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kode` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `rpjmd_dana_indikatif` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_rpjmd_tahun_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_pelaksana_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sumber_dana` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lokasi` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volume` int(10) UNSIGNED DEFAULT NULL,
  `satuan` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `rpjmd_kegiatan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_rpjmd_sub_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sasaran` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lokasi` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keluaran` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sasaran_manfaat` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pola` enum('Swakelola','Kerjasama','Pihak Ketiga') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `rpjmd_subbidang` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_rpjmd_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_sub_bidang` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `rpjmd_tahun_kegiatan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_rpjmd_kegiatan` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `sumber_dana` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
