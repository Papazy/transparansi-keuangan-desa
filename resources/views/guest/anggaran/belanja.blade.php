...
<div class="container mt-5">
    ...
    <div class="text-center mb-5">
        ...
        <select class="form-select" id="tahun" onchange="window.location.href = '/anggaran/' + this.value + '/belanja?desa=' + '{{ request('desa') }}'">
        ...
        <table class="table table-hover table-bordered">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th style="width: 30%;">Uraian Kegiatan dan Belanja</th>
